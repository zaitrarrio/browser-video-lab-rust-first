...
// every response so that SharedArrayBuffer (required by threaded ONNX Runtime
// Web) is available on hosts that cannot set headers themselves, e.g. GitHub Pages.
